...
export default {
  ...
  award_total_nominations: '提名数',
  award_total_recognized: '获奖人数',
  award_total_support: '支持总数',
  award_about_title: '关于奖项',
  award_meaning: '奖项意义',
  award_meaning_description: '表彰在开放协作中展现出卓越精神和无私奉献的个人。',
  award_criteria: '提名标准',
  award_criteria_description: '任何在过去一年里给你留下深刻印象或提供过帮助的人都值得被看见。',
  award_open_data: '开放记录',
  award_open_data_description: '提名和支持数据来自社区共同维护的飞书多维表格。',
  ...
  award_rule_nominate_description: '通过飞书表单介绍被提名人、提名理由和提名视频。',
  award_rule_review: '数据同步',
  award_rule_review_description: '表单记录由网站服务端从飞书多维表格读取并展示。',
  award_rule_support: '社区支持',
  award_rule_support_description: '页面展示来自多维表格的真实支持数据，不在浏览器本地计票。',
  award_rule_recognize: '获得认可',
  award_rule_recognize_description: '支持数达到标准后，该提名会进入获奖者名单。',
  ...
  award_faq_who_question: '谁可以参与提名？',
  award_faq_who_answer: '任何人都可以提名在过去一年里帮助过自己或留下深刻印象的人。',
  award_faq_video_question: '如何提交提名视频？',
  award_faq_video_answer: '先将视频上传到 Bilibili，再把视频链接填写到飞书提名表单中。',
  award_faq_data_question: '提名数据保存在哪里？',
  award_faq_data_answer: '表单内容直接保存到社区的飞书多维表格，并由网站服务端读取。',
