export default {
  ...
  // Award page
  award_page_title: '开放协作人奖 - 开源市集',
  award_badge: '✨ 社区荣誉 · 激励同行',
  award_intro:
    '发掘身边的开源之星，记录每一次不凡付出。开放协作人奖旨在表彰在开源协作、文档、布道及社区生态建设中做出突出贡献的优秀个人。',
  award_nominate_button: '📝 我要提名',
  award_view_nominees_button: '🔍 查看候选人',
  award_video_title: '开放协作人奖提名倡议',
  award_video_caption: '📺 观看视频：听听开源市集联合发起人关于【开放协作人奖】的提名倡议',
  award_what_title: '什么是开放协作人奖？',
  award_what_desc:
    '是由开源市集社区发起的重要奖项，面向所有对开源世界怀揣热忱、在技术共享与协同合作中默默奉献的伙伴。你的点滴付出，社区与大家共同见证。',
  award_who_title: '谁可以被提名？',
  award_who_desc:
    '不限角色！可以是贡献核心代码的硬核开发者、细致翻译或补全文档的撰写者、积极组织运营活动的志愿者，亦或是热心解答新人疑问的社群导师。',
  award_rules_title: '规则与奖励',
  award_rules_desc:
    '任何人皆可在线填写右侧提名表单。被提名人公示后接受社区成员的投票支持，最终根据贡献事实由社区委员会核定颁发“开放协作人勋章/证书”及专属权益。',
  award_nominee_list_title: '👥 提名候选人榜单',
  award_empty_title: '暂无提名人选',
  award_empty_desc: '成为第一个发现身边闪光贡献者的人吧，在右侧提交您的提名！',
  award_nominator_meta: '提名人：',
  award_time_meta: '提名时间：',
  award_recent: '近期',
  award_reason_meta: '💡 提名事迹及理由：',
  award_evidence_meta: '🔗 证明材料：',
  award_evidence_link: '查看视频链接 ↗',
  award_votes_label: '支持票数',
  award_vote_button: '👍 投票',
  award_form_title: '提拔英才 · 推荐提名',
  award_form_desc: '发现身边热爱开源、无私奉献的伙伴，为他/她赢取社区至高荣誉与奖励。',
  award_submit_success: '🎉 提名提交成功！候选人榜单已更新。',
  award_required_error: '请填写所有必填字段（提名人、被提名人、提名理由）',
  award_submit_error: '提交提名失败，请检查网络或稍后重试',
  award_vote_error: '投票失败，请重试',
  award_nominator_field: '您的名字 / 提名人',
  award_nominator_placeholder: '请输入您的名字或 GitHub ID',
  award_nominee_name_field: '被提名人名字',
  award_nominee_name_placeholder: '请输入被提名者的名字或 GitHub ID',
  award_nominee_desc_field: '被提名人简介',
  award_optional: '(选填)',
  award_nominee_desc_placeholder: '例如：核心开发者、文档布道师、设计志愿者等',
  award_reason_field: '提名事迹与理由',
  award_reason_placeholder:
    '请详细描述该被提名人的具体事迹、突出贡献以及您推荐他/她获得该奖项的理由（如：在特定项目或活动中的表现，字数不限）',
  award_video_field: '相关视频 / 证明链接',
  award_video_placeholder: '可提供相关视频介绍、代码PR、或活动回放链接',
  award_submit_loading: '正在提交...',
  award_submit_button: '✈️ 确认提交提名',
