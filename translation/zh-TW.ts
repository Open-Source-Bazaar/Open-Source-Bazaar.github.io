export default {
  ...
  library_browse_catalog: '瀏覽圖書目錄',
  library_borrow_guide: '借閱指南',
  library_stat_total_label: '館藏圖書',
  library_stat_total_desc: '涵蓋開源文化、社群營運、工程協作與授權實務。',
  library_stat_available_label: '目前可借',
  library_stat_available_desc: '可直接聯繫管理員登記借閱。',
  library_stat_borrowed_label: '已借出',
  library_stat_borrowed_desc: '可查看歸還資訊並預約下一次借閱。',
  library_catalog_title: '圖書目錄',
  library_catalog_description: '依主題查看館藏、書架編號、可借狀態和借閱說明。',
  library_status_legend: '狀態：可借 / 已借出',
  library_status_available: '可借',
  library_status_borrowed: '已借出',
  library_category_open_source: '開源文化',
  library_category_community: '社群營運',
  library_category_engineering: '工程協作',
  library_category_governance: '治理實踐',
  library_category_license: '授權條款',
  library_book_cathedral_title: '《大教堂與市集》',
  library_book_cathedral_author: 'Eric S. Raymond',
  library_book_cathedral_description:
    '經典開源文化讀本，介紹開放協作、快速迭代與社群共創的軟體開發模式。',
  ...
  library_book_producing_oss_description:
    '圍繞開源專案啟動、溝通、貢獻流程與維護者職責的實用指南。',
  library_book_pro_git_title: '《Pro Git》',
  library_book_pro_git_author: 'Scott Chacon 與 Ben Straub',
  library_book_pro_git_description: '系統講解 Git 的日常協作、分支模型和分散式版本控制工作流。',
  library_book_community_playbook_title: '開源社群行動手冊',
  library_book_community_playbook_author: 'Open Source Bazaar',
  library_book_community_playbook_description:
    '面向社群組織者的活動策劃、志工協作、貢獻者成長與復盤模板。',
  library_book_governance_title: '開源治理指南',
  library_book_governance_author: 'Open Source Initiative',
  library_book_governance_description: '梳理治理結構、決策機制、行為準則和專案永續性建設要點。',
  library_book_license_title: '開源授權手冊',
  library_book_license_author: 'Open Source Bazaar',
  library_book_license_description: '協助貢獻者理解常見授權條款、複用邊界和專案合規檢查清單。',
  library_book_available_note: '可借閱，提交登記後等待管理員確認。',
  library_book_borrowed_note: '已借出，可聯繫管理員預約歸還後的下一位。',
  library_shelf_code: '書架編號',
  library_borrow_status: '借閱資訊',
  library_borrow_guide_description: '三步完成借閱登記，管理員確認後即可線下領取或約定交付方式。',
  library_guide_step_1: '在目錄中找到想借閱的書籍，記錄書名與書架編號。',
  library_guide_step_2: '透過開源市集懸賞或活動頁面聯繫管理員，提交姓名、聯絡方式和預計歸還時間。',
  library_guide_step_3: '管理員確認可借狀態後完成登記，並同步歸還提醒或預約排隊資訊。',
  library_submit_books: '提交新書或借閱請求',
