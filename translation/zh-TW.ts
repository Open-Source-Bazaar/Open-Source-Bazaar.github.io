export default {
  ...
  // Award page
  award_page_title: '開放協作人獎 - 開源市集',
  award_badge: '✨ 社群榮譽 · 激勵同行',
  award_intro:
    '發掘身邊的開源之星，記錄每一次不凡付出。開放協作人獎旨在表彰在開源協作、文件、布道及社群生態建設中做出突出貢獻的優秀個人。',
  award_nominate_button: '📝 我要提名',
  award_view_nominees_button: '🔍 查看候選人',
  award_video_title: '開放協作人獎提名倡議',
  award_video_caption: '📺 觀看影片：聽聽開源市集聯合發起人關於【開放協作人獎】的提名倡議',
  award_what_title: '什麼是開放協作人獎？',
  award_what_desc:
    '這是由開源市集社群發起的重要獎項，面向所有對開源世界懷抱熱忱、在技術共享與協同合作中默默奉獻的夥伴。你的點滴付出，社群與大家共同見證。',
  award_who_title: '誰可以被提名？',
  award_who_desc:
    '不限角色！可以是貢獻核心代碼的硬核開發者、細緻翻譯或補全文檔的撰寫者、積極組織營運活動的志工，亦或是熱心解答新人疑問的社群導師。',
  award_rules_title: '規則與獎勵',
  award_rules_desc:
    '任何人皆可在線填寫右側提名表單。被提名人公示後接受社群成員的投票支持，最終根據貢獻事實由社群委員會核定頒發「開放協作人勳章/證書」及專屬權益。',
  award_nominee_list_title: '👥 提名候選人榜單',
  award_empty_title: '暫無提名人選',
  award_empty_desc: '成為第一個發現身邊閃光貢獻者的人吧，在右側提交您的提名！',
  award_nominator_meta: '提名人：',
  award_time_meta: '提名時間：',
  award_recent: '近期',
  award_reason_meta: '💡 提名事跡及理由：',
  award_evidence_meta: '🔗 證明材料：',
  award_evidence_link: '查看影片連結 ↗',
  award_votes_label: '支持票數',
  award_vote_button: '👍 投票',
  award_form_title: '提拔英才 · 推薦提名',
  award_form_desc: '發現身邊熱愛開源、無私奉獻的夥伴，為他/她贏取社群至高榮譽與獎勵。',
  award_submit_success: '🎉 提名提交成功！候選人榜單已更新。',
  award_required_error: '請填寫所有必填欄位（提名人、被提名人、提名理由）',
  award_submit_error: '提交提名失敗，請檢查網路或稍後重試',
  award_vote_error: '投票失敗，請重試',
  award_nominator_field: '您的名字 / 提名人',
  award_nominator_placeholder: '請輸入您的名字或 GitHub ID',
  award_nominee_name_field: '被提名人名字',
  award_nominee_name_placeholder: '請輸入被提名者的名字或 GitHub ID',
  award_nominee_desc_field: '被提名人簡介',
  award_optional: '(選填)',
  award_nominee_desc_placeholder: '例如：核心開發者、文件布道師、設計志工等',
  award_reason_field: '提名事跡與理由',
  award_reason_placeholder:
    '請詳細描述該被提名人的具體事跡、突出貢獻以及您推薦他/她獲得該獎項的理由（如：在特定項目或活動中的表現，字數不限）',
  award_video_field: '相關影片 / 證明連結',
  award_video_placeholder: '可提供相關影片介紹、代碼 PR、或活動回放連結',
  award_submit_loading: '正在提交...',
  award_submit_button: '✈️ 確認提交提名',
  ...
  back: '返回',
  by_author: ({ authors }: { authors: string }) => `作者：${authors}`,
