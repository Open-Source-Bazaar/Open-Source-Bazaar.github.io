...
export default {
  ...
  award_total_nominations: '提名數',
  award_total_recognized: '獲獎人數',
  award_total_support: '支持總數',
  award_about_title: '關於獎項',
  award_meaning: '獎項意義',
  award_meaning_description: '表彰在開放協作中展現出卓越精神和無私奉獻的個人。',
  award_criteria: '提名標準',
  award_criteria_description: '任何在過去一年裡給你留下深刻印象或提供過幫助的人都值得被看見。',
  award_open_data: '開放記錄',
  award_open_data_description: '提名和支持數據來自社群共同維護的飛書多維表格。',
  ...
  award_rule_nominate: '提交提名',
  award_rule_nominate_description: '透過飛書表單介紹被提名人、提名理由和提名影片。',
  award_rule_review: '資料同步',
  award_rule_review_description: '表單記錄由網站伺服器從飛書多維表格讀取並展示。',
  award_rule_support: '社群支持',
  award_rule_support_description: '頁面展示來自多維表格的真實支持數據，不在瀏覽器本地計票。',
  award_rule_recognize: '獲得認可',
  award_rule_recognize_description: '支持數達到標準後，該提名會進入獲獎者名單。',
  ...
  award_faq_who_question: '誰可以參與提名？',
  award_faq_who_answer: '任何人都可以提名在過去一年裡幫助過自己或留下深刻印象的人。',
  award_faq_video_question: '如何提交提名影片？',
  award_faq_video_answer: '先將影片上傳到 Bilibili，再把影片連結填寫到飛書提名表單中。',
  award_faq_data_question: '提名數據儲存在哪裡？',
  award_faq_data_answer: '表單內容直接儲存到社群的飛書多維表格，並由網站伺服器讀取。',
