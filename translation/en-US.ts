export default {
  ...
  finance_hero_title: 'Index Fund Investing 璺?China Selection',
  finance_hero_intro:
  ...
  finance_hero_stat_risk_sub: 'Conservative 璺?Balanced 璺?Aggressive',
  ...
  hackathon_action_hub: 'Action Hub 璺?Forms',
  ...
  open_library_description: 'Browse open source and technical books, support borrowing and sharing',
  book_catalog: 'Book Catalog',
  search_books_placeholder: 'Search by title, author, or tags...',
  library_category_all: 'All Categories',
  library_category_open_source: 'Open Source',
  library_category_programming: 'Programming',
  library_category_community: 'Community',
  library_category_design: 'Design',
  library_category_business: 'Business',
  library_status_all: 'All Status',
  library_status_available: 'Available',
  library_status_borrowed: 'Borrowed',
  view_details: 'View Details',
  back_to_library: 'Back to Library',
  no_books_found: 'No matching books found',
  ...
  language: 'Language',
  category: 'Category',
  borrowing_info: 'Borrowing Info',
  borrower: 'Borrower',
  borrow_date: 'Borrow Date',
  expected_return_date: 'Expected Return Date',
  borrowing_guide: 'Borrowing Guide',
  borrowing_guide_step1: 'Select a book you are interested in from the catalog',
  borrowing_guide_step2: 'View book details and confirm availability',
  borrowing_guide_step3: 'Contact Open Source Bazaar admin to submit a borrow request',
  borrowing_guide_step4: 'After admin approval, pick up the book at the designated location',
  borrowing_guide_step5: 'Please return on time so others can borrow',
  // Award page
