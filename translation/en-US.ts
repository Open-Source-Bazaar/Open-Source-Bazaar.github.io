export default {
  ...
  finance_hero_title: 'Index Fund Investing 路 China Selection',
  finance_hero_intro:
  ...
  finance_hero_stat_risk_sub: 'Conservative 路 Balanced 路 Aggressive',
  ...
  hackathon_action_hub: 'Action Hub 路 Forms',
