...
const isPublicForm = ({ shared, shared_limit }: TableFormView) =>
  shared ||
  ["tenant_editable", "anyone_editable"].includes(shared_limit as string);
      ...
      <>
                    ...
                    <Card className={styles.infoCard} body>
                      ...
                      <p className="text-white-50 mb-0">
                        <time dateTime={startTime as string}>
                          {formatDate(startTime as string)}
                        </time>{" "}
                        -{" "}
                        <time dateTime={endTime as string}>
                          {formatDate(endTime as string)}
                        </time>
                      </p>
                    </Card>
                  </Col>
                  ...
                  <Card.Body>
                    {agendaPreview[0] && (
                      <dl className="d-grid gap-3 mb-0">
                        <div
                          className={`${styles.heroVisualHead} ${styles.heroVisualItem}`}
                        >
                          <dt className={styles.heroVisualKicker}>
        ...
        <Container className="my-5">
                  ...
                  <Col as="li" key={key}>
                    <Card className={styles.entryCard} body>
                      <span className={styles.entryStep}>
                        {t("hackathon_step")}{" "}
                        {String(index + 1).padStart(2, "0")} · {t(meta.eyebrow)}
                      </span>
          ...
          <section className={styles.section}>
            ...
            <Row
              as="ul"
              className="list-unstyled mt-4 g-3"
              md={2}
              lg={3}
              xl={4}
            >
