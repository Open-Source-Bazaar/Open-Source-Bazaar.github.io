...
} from '../../components/Activity/Hackathon/HackathonActionHub';
import { HackathonAwards } from '../../components/Activity/Hackathon/HackathonAwards';
import type { HackathonAwardsMeta } from '../../components/Activity/Hackathon/HackathonAwards';
...
const HackathonDetail: FC<HackathonDetailProps> = observer(
  ({ activity, hackathon }) => {
    ...
    const formMap = (forms || {}) as Partial<
    ...
    return (
      <>
        ...
        {formGroups[0] && (
          <HackathonActionHub
            entries={formGroups.map(
              ({ description, eyebrow, links, title }) => ({
                title,
                description,
                eyebrow,
                links,
            ...
            primaryDescription={
              primaryForm?.description || t('hackathon_entry_flow_description')
            }
